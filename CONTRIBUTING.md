...
Thank you for your interest in contributing to Couic!

## Before you begin contributing

### Code of conduct

Please review and adhere to the [code of conduct](CODE_OF_CONDUCT.md) before contributing any pull requests or issues.

### Level of support

We do not offer general support for using or setting up the project and there is no commitment regarding processing times.
...
1. **Fork the repository**: start by forking the couic repository to your GitHub account.
2. **Clone the repository**: clone your forked repository to your local machine using:

    ```bash
    git clone https://github.com/your-username/couic.git
    ```

3. **Set upstream remote**: add the original repository as an upstream remote to keep your fork in sync:

    ```bash
    git remote add upstream https://github.com/FCSC-FR/couic.git
    ```
...
Thank you for contributing to couic!
